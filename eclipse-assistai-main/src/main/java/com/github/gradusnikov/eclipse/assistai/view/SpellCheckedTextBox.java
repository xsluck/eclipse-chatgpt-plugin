...
public class SpellCheckedTextBox {
    ...
    /**
     * Adds a key listener to the text widget to handle specific key events for undo
     * and redo operations. This method listens for 'z' key presses combined with
     * modifier keys to execute undo and redo.
     */
    ...
    class CustomSourceViewerConfiguration extends TextSourceViewerConfiguration {
        ...
        class QuickAssistTextHover extends DefaultTextHover {
            ...
            public IRegion getHoverRegion(ITextViewer textViewer, int offset) {
                Display.getDefault()
                        .asyncExec(() -> ((SourceViewer) sourceViewer).doOperation(ISourceViewer.QUICK_ASSIST));
                return null;
            }
