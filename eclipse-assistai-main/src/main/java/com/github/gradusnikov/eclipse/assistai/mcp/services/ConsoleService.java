...
public class ConsoleService {
     ...
     * @param includeAllConsoles Whether to include output from all available
     *                           consoles
    ...
    private void readConsoleOutput(StringBuilder result, String consoleName, final int finalMaxLines,
            final boolean finalIncludeAllConsoles) {
        try {
            ...
            if (consoleName != null && !consoleName.trim().isEmpty()) {
                ...
                Optional<IConsole> consoleOptional = Optional
            ...
            try {
                ...
                try {
                    ...
                    if (window != null && window.getActivePage() != null) {
                        IConsoleView view = (IConsoleView) window.getActivePage()
    ...
    private MessageConsole findOrCreateConsole(String name) throws PartInitException {
        ...
        // Show the console view
        var page = Optional.ofNullable(PlatformUI.getWorkbench()).map(IWorkbench::getActiveWorkbenchWindow)
                .map(IWorkbenchWindow::getActivePage)
