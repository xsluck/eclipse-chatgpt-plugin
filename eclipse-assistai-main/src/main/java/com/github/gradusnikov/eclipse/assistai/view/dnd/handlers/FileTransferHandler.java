...
public class FileTransferHandler implements ITransferHandler {
    ...
    private boolean isTextContent(String contentType) {
        ...
        String[] textBasedTypes = { "csv", "json", "xml", "javascript", "typescript", "html", "css", "markdown", "yaml",
                "yml", "properties", "java", "c", "cpp", "h", "py", "rb", "php", "sql", "sh", "bat", "ps1", "ini",
                "conf", "log", "gradle", "groovy", "kt", "scala", "md" };
