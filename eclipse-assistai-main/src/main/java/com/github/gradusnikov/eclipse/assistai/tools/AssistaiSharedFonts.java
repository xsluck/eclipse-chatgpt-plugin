...
public class AssistaiSharedFonts {
    ...
    private record FontInfo(String fontFamily, String fontWeight, String fontStyle, String fontDataBase64,
            String format) {
    };
    ...
    private FontInfo readFontWithFontBox(String path) {
        ...
        var fontFamily = Paths.get(path).getFileName().toString().replaceFirst("\\.[^.]+$", "")
    ...
    private String toFontFaceCss(FontInfo fontInfo) {
        ...
        fontFaceTemplate = fontFaceTemplate.replace("${fontFamily}", fontInfo.fontFamily)
                .replace("${fontWeight}", fontInfo.fontWeight).replace("${fontStyle}", fontInfo.fontStyle)
                .replace("${fontDataBase64}", fontInfo.fontDataBase64).replace("${format}", fontInfo.format);
    ...
    public String loadFontsCss() {
        String[] fontFiles = { "fonts/fa-regular-400.ttf", "fonts/fa-solid-900.ttf", "fonts/KaTeX_AMS-Regular.ttf",
                "fonts/KaTeX_Caligraphic-Bold.ttf", "fonts/KaTeX_Caligraphic-Regular.ttf",
                "fonts/KaTeX_Fraktur-Bold.ttf", "fonts/KaTeX_Fraktur-Regular.ttf", "fonts/KaTeX_Main-Bold.ttf",
                "fonts/KaTeX_Main-BoldItalic.ttf", "fonts/KaTeX_Main-Italic.ttf", "fonts/KaTeX_Main-Regular.ttf",
                "fonts/KaTeX_Math-BoldItalic.ttf", "fonts/KaTeX_Math-Italic.ttf", "fonts/KaTeX_SansSerif-Bold.ttf",
                "fonts/KaTeX_SansSerif-Italic.ttf", "fonts/KaTeX_SansSerif-Regular.ttf",
                "fonts/KaTeX_Script-Regular.ttf", "fonts/KaTeX_Size1-Regular.ttf", "fonts/KaTeX_Size2-Regular.ttf",
                "fonts/KaTeX_Size3-Regular.ttf", "fonts/KaTeX_Size4-Regular.ttf",
                "fonts/KaTeX_Typewriter-Regular.ttf" };
        try {
            var css = Arrays.stream(fontFiles).map(this::readFontWithFontBox).map(this::toFontFaceCss)
