...
/**
 * Custom Maven execution listener that captures Maven build output and
 * redirects it to the console.
 */
public class CustomMavenExecutionListener extends MonitorExecutionListener {
    ...
    /**
     * Creates a new Maven execution listener that redirects output to the specified
     * console.
     * 
     ...
     */
    public CustomMavenExecutionListener(IProgressMonitor monitor, String consoleName, ConsoleService consoleService) {
        super(monitor);
    ...
    public void mojoStarted(ExecutionEvent event) {
        ...
        writeToConsole("Executing " + mojo.getGroupId() + ":" + mojo.getArtifactId() + ":" + mojo.getVersion() + ":"
                + mojo.getGoal());
    }
    ...
    public void mojoFailed(ExecutionEvent event) {
        ...
        MojoExecution mojo = event.getMojoExecution();
        writeToConsole("FAILED: " + mojo.getGroupId() + ":" + mojo.getArtifactId() + ":" + mojo.getVersion() + ":"
                + mojo.getGoal());
