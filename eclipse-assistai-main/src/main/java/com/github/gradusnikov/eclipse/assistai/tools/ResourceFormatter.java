...
public class ResourceFormatter {
    ...
    public enum Indexing {
         ...
         * 
         * @param addToIndex The value to add to the index when formatting line numbers
         */
         ...
         * 
         * @param lineNumber The zero-based line number to adjust
     ...
     * 
     * @param file The Eclipse IFile resource to format
     */
     ...
     * @throws CoreException If a Core exception occurs
     */
     ...
     * 
     * @param from The zero-based starting line number (inclusive)
     * @param to   The zero-based ending line number (inclusive)
     * @return A formatted string containing the specified range of lines with line
     *         numbers
     * @throws IOException   If an I/O error occurs while reading the file
     * @throws CoreException If a Core exception occurs
     */
     ...
     * 
     * @param lines The list of lines to format
     * @param from  The zero-based starting line index (inclusive)
     * @param to    The zero-based ending line index (inclusive)
